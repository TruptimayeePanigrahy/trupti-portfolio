            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-12 xl:px-16 2xl:px-24">
                <div className="max-w-4xl mx-auto">
                    <div className="text-center mb-12">
                        ...
                        <div className="w-24 h-1 bg-green-600 dark:bg-cyan-500 mx-auto rounded mb-6"></div>
                        ...
                        <div className="grid md:grid-cols-2 gap-8">
                            <div className="space-y-6">
                                <div className="flex items-start gap-4 group">
                                    <div className="w-12 h-12 bg-gradient-to-br from-orange-600 to-amber-600 hover:from-orange-700 hover:to-amber-700 rounded-lg flex items-center justify-center group-hover:scale-110 group-hover:shadow-lg group-hover:shadow-orange-500/50 transition-all">
                                    ...
                                    <div>
                                        ...
                                        <a
                                            href="mailto:Truptimayeepanigrahy2001@gmail.com"
                                            className="text-teal-600 dark:text-cyan-400 hover:text-teal-500 dark:hover:text-cyan-300 hover:underline transition-colors"
                                        >
                                            truptimayeepanigrahy2001@gmail.com
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div className="flex items-start gap-4 group">
                                    ...
                                    <div>
                                        ...
                                        <p className="text-slate-600 dark:text-slate-400">Berhampur, Odisha, India</p>
                                    </div>
                                </div>
                            </div>
